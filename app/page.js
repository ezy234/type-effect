  ...
  return (
    <div className=" flex justify-center h-screen text-center overflow-hidden">
      ...
      <div className="glass w-[50vw] h-[40vh] animate__animated animate__lightSpeedInRight">
        ...
        <p className="animate__animated animate__zoomInDown animate_delay-3s text-[1.2rem] font-[500] mt-[0.5rem]">
          A cross-browser library for CSS animation
        </p>
        <p className="animate__animated animate__zoomInDown animate_delay-4s text-[1rem] font-[300] mt-[0.5rem]">
